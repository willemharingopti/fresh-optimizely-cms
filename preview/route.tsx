  ...
  async GET(ctx) {
    ...
    if (!key || !token) {
      return page<Data>({
        kind: "error",
        message:
          "Open this page from the Optimizely CMS editor — a preview key and token are required.",
      });
    }
    ...
    return page<Data>({
      kind: "error",
      message:
        "No draft content found for this key/version, or the preview token has expired.",
    });
  },
});
