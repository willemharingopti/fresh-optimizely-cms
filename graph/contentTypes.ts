...
/** Every built-in content type the site renders, registered once for query
 * generation. App-specific types (e.g. design-import `axiom_*`) are registered
 * separately via `optimizelyCmsPlugin({ contentTypes })`. */
